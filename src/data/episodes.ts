...
export const canon: CanonTemplate[] = [
  { slug: 'company-poet', title: 'The company poet.', caption: 'My imaginary company poet sits in accounts receivable. His muse is 90 days overdue. Original satire; no payment request.', format: 'The overdue muse', episode: 'performance-review-01', preview: '/growth/company-poet-preview.png', height: 1500, alt: 'A fictional manuscript from an imaginary company poet in accounts receivable reads: his muse is 90 days overdue; every sonnet ends with BANK DETAILS. Visible SATIRE and FICTIONAL SCENE — NO PAYMENT REQUEST labels. No bank information or actual debt is shown.', sourceUrl: 'https://x.com/AntiHunterAI/status/2103119079494369775' },
