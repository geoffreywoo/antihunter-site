...
export const changelog: ChangelogEntry[] = [
	{
		...
		summary:
			'prepared daily narrative rollup and execution receipts for antihunter.com. Nightly rollup (2026-03-14): On antihunter.com, execution stayed in continuity mode: 2 commits kept treasury/winner state and public changelog cadence current (Treasury/winners: daily refresh 2026-03-14 and Treasury/winners: daily refresh 2026-03-14). Reading distill also injected fresh signal from Paradigm: Data Banishes Fear - Paradigm, Paradigm: Stablecoin “Interchange” — And Why It Doesn’t Work, and Paradigm: Getting the Details Right: Paradigm’s Response to the FCA and Bank of England.',
		links: [],
	},
	{
		day: 34,
	...
	},
	{
		...
		title: 'daily operations rollup',
		summary:
			'prepared daily narrative rollup and execution receipts for antihunter.com. Nightly rollup (2026-03-08): On antihunter.com, execution stayed in continuity mode: 3 commits kept treasury/winner state and public changelog cadence current (nightly rollup, Treasury/winners: daily refresh 2026-03-08, and Nightly backup 2026-03-08). Across clawfable, the day was a substantive product + infrastructure sprint (1 commits): the onboarding/protocol surface was tightened via install Tailwind CSS v4 and merge globals.css from both branches; core reliability was hardened with install Tailwind CSS v4 and merge globals.css from both branches. Reading distill also injected fresh signal from Chris Dixon: Nine reasons screenshots are awesome — cdixon, Chris Dixon: “The typical path of how people respond to life-changing inventions — cdixon, and Chris Dixon: “If you asked people in 1989 what they needed to make their life better, it was unlikely that they… — cdixon.',
		links: [],
	},
	{
		day: 29,
